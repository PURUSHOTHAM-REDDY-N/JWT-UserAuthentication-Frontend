...
export default function PrivacyPolicy() {
  ...
  return (
    ...
    <div>
        <div className='font-bold text-2xl'>Privacy Policy</div> <br />
This Privacy Policy is prepared by Purushotham and whose registered address is kadapa , AndhraPradesh , India . (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.
...
<br /><div className='font-bold text-2xl'>Types of information we may collect from you</div><br />
...
<br /><div className='font-bold text-2xl'>How we may use the information we collect</div><br />
We use the information in the following ways:
Information you supply to us. We will use this information:
to provide you with information and/or services that you request from us;
To contact you to provide the information requested.
<br /><div className='font-bold text-2xl'>Disclosure of your information</div><br />
...
<br /><div className='font-bold text-2xl'>Your rights – access to your personal data</div><br />
You have the right to ensure that your personal data is being processed lawfully (“Subject Access Right”). Your subject access right can be exercised in accordance with data protection laws and regulations. Any subject access request must be made in writing to purupowerman@gmail.com. We will provide your personal data to you within the statutory time frames. To enable us to trace any of your personal data that we may be holding, we may need to request further information from you. If you complain about how we have used your information, you have the right to complain to the Information Commissioner’s Office (ICO).
<br /><div className='font-bold text-2xl'>Changes to our privacy policy</div><br />
Any changes we may make to our privacy policy in the future will be posted on this page and, where appropriate, notified to you by e-mail. Please check back frequently to see any updates or changes to our privacy policy.
<br /><div className='font-bold text-2xl'>Contact</div><br />
Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to purupowerman@gmail.com.
